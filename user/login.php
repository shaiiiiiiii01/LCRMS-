...
<body class="admin-login-page">
    <main class="admin-login-screen">
        <section class="admin-login-card" aria-labelledby="loginTitle">
            ...
            <form class="admin-login-form" action="login.php" method="post">
                <div class="admin-form-group">
                    ...
                    <div class="admin-input-shell">
                        ...
                        <input id="username" name="username" type="text" placeholder="Username" autocomplete="username" value="<?php echo htmlspecialchars($_POST['username'] ?? ''); ?>" required>
                ...
                <div class="admin-form-group">
                    ...
                    <div class="admin-input-shell">
                        ...
                        <button class="admin-input-icon-button" type="button" data-toggle-password aria-label="Show password">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
